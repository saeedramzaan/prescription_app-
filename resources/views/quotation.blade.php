    ...
    <div class="container">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="search1" id="search1"
                                                    placeholder="Enter the key" class="form-control">
                                            </div>
                                    ...
                                    <form id="formId" method="POST" action="{{ route('saveItem') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="id" type="hidden" class="form-control"
                                                    @error('id') is-invalid
                                                @enderror
                                                    name="id" value="{{ $quo->patient_id }}" required
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="name" type="hidden" class="form-control"
                                                    @error('name')
                                                is-invalid @enderror
                                                    name="name" value="{{ $quo->patient_name }}" required
                                                    autocomplete="name" autofocus>
                                        ...
                                        <div class="row mb-3">
                                            <label for="password-confirm"
                                                class="col-md-4 col-form-label text-md-end">{{ __('drug_name') }}</label>

                                            <div class="col-md-6">

                                                <input id="drug_name" type="text"
                                                    class="form-control @error('drug_name') is-invalid @enderror"
                                                    name="drug_name" required disabled>
        ...
        <body>
            ...
            <script type="text/javascript">
                        ...
                        success: function(dataResult) {
                            ...
                            $.each(resultData, function(index, row) {
                                ...
                                for (let i = 0; i < img.length; i++) {
                                    $("#row-img").append(
                                        "<div class='column' id='img' style='float: left;width: 25%;'padding: 10px;'><img src='http://localhost:8000/images/" +
                                        img[i] +
                                        "' alt='Nature' style='width:100%' onclick='myFunction(this);'></div>"
                                    );
                ...
                function showItem() {
                    let url = $('meta[name=app-url]').attr("content") + "/productInfo";
                    $.ajax({
                        ...
                        success: function(dataResult) {
                            ...
                            $.each(resultData, function(index, row) {
                                ...
                                bodyData += "<td>" + row.id + "</td><td>" + row.drug_name +
                                    "</td><td>" + row.price + "</td><td>" + row.qty + "</td><td>" + row
                                    .prescription_id +
                                    "</td><td>" + row.total + "</td>"
                                bodyData += "</tr>";
                                $("#itemData").html("");
                            })
                            bodyData += "<tr><td>Total</td><td></td><td></td><td></td><td></td><td>" + dataResult.tot +
                                "</td></tr>";
                ...
                function showAllProjects() {
                    ...
                    let url = $('meta[name=app-url]').attr("content") + "/productInfo";
                    $.ajax({
                        url: "http://localhost:8000/productInfo",
                        type: "GET",
                        cache: false,
                        dataType: 'json',
                        success: function(dataResult) {
                        ...
                        $.ajax({
                            ...
                            success: function(dataResult) {
                                ...
                                $.each(resultData, function(index, row) {
                                    ...
                                    bodyData += "<tr onclick='get_week(this)' id='" + row
                                        .price + "'>"
                                    bodyData += "<td>" + row.id + "</td><td>" + row.drug_name +
                                        "</td><td>" + row.price + "</td>";
                                    $("#bodyData").html("");
